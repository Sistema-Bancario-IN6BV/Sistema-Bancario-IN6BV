...
const Field = ({ icon, label, name, type = 'text', value, onChange, placeholder, ...rest }) => (
  <div className="field-group">
    ...
    <input className="field-input" type={type} name={name} value={value}
      ...
      <div className="register-card">
        <div className="register-card-header">
          ...
          <div>
            ...
            <p className="register-subtitle">Registro de cliente</p>
          </div>
        </div>
        ...
        <form className="register-form" onSubmit={handleSubmit}>
          ...
          <div className="field-group">
            ...
            <div className="pwd-wrap">
              <input className="field-input" type={showPwd ? 'text' : 'password'}
          ...
          <div className="field-group">
            ...
            <input className="field-input" type="text" name="address" value={form.address}
